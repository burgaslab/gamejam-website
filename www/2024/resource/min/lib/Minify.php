    ...
    protected static function _combineMinify()
    {
        ...
        do {
            ...
            if ($i < $l) {
                ...
                $opt = isset(self::$_options['minifierOptions'][$source->contentType])
                ? self::$_options['minifierOptions'][$source->contentType] : $defaultOptions;

                $min = isset(self::$_options['minifiers'][$source->contentType])
                ? self::$_options['minifiers'][$source->contentType] : $defaultMinifier;
                ...
                $options = (null !== $source->minifyOptions)
                    ? array_merge($opt, $source->minifyOptions)
                    : $opt;
            }
