	...
	$.swipebox = function(elem, options) {
		...
		var ui = {
			...
			openMedia : function (index){
				...
				} else if ($this.isIframe(src)){
					$('#swipebox-slider .slide').eq(index).html($this.getIframe(src));
				} else {
			...
			getIframe : function(url){
                iframe = '<iframe width="560" height="315"  src="'+url+'" frameborder="0"></iframe>';
