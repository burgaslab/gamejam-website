...
<body class="{block "body_class"}{/block}">
	<div id="page-wrap">
		...
		<div id="header" class="cf">
			<div class="wrap">
				<a href="{$base}.." class="current">&larr; Обратно към BGJ 2023</a>
				...
				<div class="logo">
					<div class="logo-wrap">
						<a href="{$base}"><img src="{$base}resource/image/public/header.png" class="pure-img" alt="Burgas Game Jam 2020" /></a>
						<p style="display: none">31 януари - 2 февруари 2020<br/>в Експозиционен център “Флора”</p>
					</div>
				</div>
				{/block}
			</div>
			...
			<div class="wrap">
				<div class="partners">
					...
					<ul class="assets">
						...
						<li><a href="https://www.scalefocus.com/" title="ScaleFocus" target="_blank"><img src="{$base}resource/image/public/partner/scalefocus.png" alt="ScaleFocus" /></a></li>
						...
						<li><a href="https://ibabg.eu/" title="IBA Group" target="_blank"><img src="{$base}resource/image/public/partner/iba-group.gif" alt="IBA Group" /></a></li>
				...
				<div class="contacts">
					<div class="pure-g">
						<div class="pure-u-1 pure-u-sm-1-4">
							<a href="{$base}support" class="support">Подкрепи Burgas Game Jam 2020</a>
						</div>
						<div class="pure-u-1 pure-u-sm-1-4">
