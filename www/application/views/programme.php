		...
		<div class="row demo-row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="inner-container trans-black">
					...
					<span><span class="badge">1<span class="up">ви</span></span> Ден (петък)</span>
				</h4>
				<a name="day1"></a>
				<div class="programme">
					...
					<p><label>20:00 – ?</label>  За най-мотивираните - продължаваме работа в <a href="http://burgaslab.org" target="_blank">БургасЛаб</a></p>
				</div>
				<h4 class="inspiration">
					<span><span class="badge">2<span class="up">ри</span></span> Ден (събота)</span>
				</h4>
				<a name="day2"></a>
				...
				<div class="programme">
					...
					<p><label>15:00</label> Краен срок за създаване на
				<a target="_blank" href="http://globalgamejam.org/user/signup/to/participate/using">индивидуален профил в сайта на GGJ</a>
				и профилна страница за играта </p>
				...
				<h4 class="inspiration">
					<span><span class="badge">3<span class="up">ти</span></span> Ден (неделя)</span>
				</h4>
				<a name="day3"></a>
				<p class="indented">
				...
				<div class="programme">
					...
					<p><label>15:00</label> Краен срок за предаване на игрите</a></p>
