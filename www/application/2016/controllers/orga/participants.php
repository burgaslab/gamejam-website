...
class Participants extends Auth {
	...
	private function participant_row($id, $mode) {
	...
	public function edit() {
		if ($this->input->is_ajax_request()) {
			...
			$this->json_response($this->participant_row($id, "edit"));
		}
	}
	...
	public function cancel() {
		if ($this->input->is_ajax_request()) {
			...
			$this->json_response($this->participant_row($id, "view"));
		}
	}
	...
	public function save() {
		if ($this->input->is_ajax_request()) {
			...
			if ($validator->is_valid()) {
				...
				$res = array(
					"success" => true,
					"data" => $this->participant_row($id, "view"),
				);
